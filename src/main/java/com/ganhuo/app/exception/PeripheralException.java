 ...
 */
package com.ganhuo.app.exception;
...
public class PeripheralException extends RuntimeException {
	...
	public PeripheralException(Logger logger, Exception e) {
		if (logger.isErrorEnabled()) {
			logger.error("Third party thrown jar.", e);
		}
	}

	public PeripheralException(Logger logger, String message) {
		if (logger.isErrorEnabled()) {
			logger.error(message);
		}
	}

	public PeripheralException(Logger logger, String message, Exception e) {
		if (logger.isErrorEnabled()) {
			logger.error("Third party thrown jar.".concat(message), e);
		}
	}
